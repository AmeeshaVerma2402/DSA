...
class SparseTable {
    ...
    SparseTable(int[] nums) {
        int n = nums.length;
        int log = Integer.SIZE - Integer.numberOfLeadingZeros(Math.max(1, n));
        st = new int[log + 1][Math.max(1, n)];
